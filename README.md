...
| Número de registro | Datos del entrevistado | Captura |
| :--- | :--- | :--- |
| **1** | **Nombre:** Cristian Salvador<br>**Edad:** 28 años<br>**Establecimiento:** Tienda de productos importados (Referente)<br>**Cargo:** Dueño / Encargado<br>**Duración:** Aprox. 5 minutos<br> **Enlace:** [https://l1nq.com/8gjygzw](https://acortar.link/gTCaPh) <br> **Resumen:** Cristian interactuó con la interfaz de GeoPS Business. Completó satisfactoriamente el registro de su local, pero experimentó un punto de dolor crítico al crear una "Oferta Relámpago": la plataforma web le permitió guardar el anuncio sin haber cargado obligatoriamente la imagen del producto. Valora la utilidad de la geolocalización hiperlocal con un 4, enfatizando la necesidad de alertas restrictivas antes de publicar para no afectar la estética de su feed comercial. |  **Figura 4**<br> *Entrevista 1 — Segmento 2* <div align="center"> <img src="resources/imgs/chapter-ii/entrevista1_segmento1.png" alt="Entrevista 1 — Segmento 2" width="4000"> </div> *Nota.* Elaboración propia. |
| **2** | **Nombre:** Néstor Rojas<br>**Establecimiento:** Terra Inc.<br>**Giro:** Inciensos, plantas y productos orgánicos asiáticos<br>**Duración:** Aprox. 8 minutos<br> **Enlace:** https://acortar.link/aSbB2F <br>**Resumen:** Néstor realizó la prueba guiada del panel de control de ofertas. Logró delimitar con éxito el radio de 1 km sobre el mapa interactivo, pero reportó que el sistema procesó sus datos informativos sin realizar una validación sintáctica en tiempo real sobre su número de RUC comercial. Califica la solución con un 4, sugiriendo incorporar de forma indispensable máscaras de texto restrictivas para evitar el envío de datos erróneos al backend. |  **Figura 5**<br> *Entrevista 1 — Segmento 2* <div align="center"> <img src="resources/imgs/chapter-ii/entrevista2_segmento1.png" alt="Entrevista 1 — Segmento 2" width="4000"> </div> *Nota.* Elaboración propia. |
...
| Número de registro | Datos del entrevistado | Captura |
| :--- | :--- | :--- |
| **1** | **Nombre:** Ariana Puscan <br> **Edad:** 28 años <br> **Distrito:** Magdalena <br> **Ocupación:** Abogada <br> **Duración de la entrevista:** 5 minutos y 49 segundos <br> **Enlace:** https://l1nq.com/8gjygzw <br> **Resumen:** Ariana interactuó con la plataforma web desde el navegador de su smartphone (entorno responsive). Al desplazarse por los límites zonales de su distrito para buscar snacks asiáticos, experimentó una fuerte saturación visual y superposición caótica de pines debido a la alta densidad de comercios en el área y la falta de clusterización. Valora la inmediatez de la solución con un 4, indicando que es vital agrupar los marcadores por cercanía. | **Figura 6**<br> *Entrevista 1 — Segmento 2* <div align="center"> <img src="resources/imgs/chapter-ii/entrevista1_segmento2.png" alt="Entrevista 1 — Segmento 2" width="4000"> </div> *Nota.* Elaboración propia. |
| **2** | **Nombre:** Olga Consuelo Arce Quesada <br> **Edad:** 25 años <br> **Distrito:** Magdalena <br> **Ocupación:** Comunicadora Corporativa <br> **Duración de la entrevista:** 7 minutos y 16 segundos <br> **Enlace:** https://l1nq.com/ck0dyrh <br> **Resumen:** Olga navegó sobre el mapa interactivo en búsqueda de productos de belleza y cosmética coreana. Validó de forma muy positiva el despliegue de las listas de precios en tiempo real dentro del detalle de los locales. No obstante, sugirió que la interfaz requiere añadir filtros de búsqueda mucho más avanzados por categorías específicas dentro del propio mapa para agilizar la toma de decisiones del consumidor. Califica el producto con 4 estrellas. | **Figura 7**<br> *Entrevista 2 — Segmento 2* <div align="center"> <img src="resources/imgs/chapter-ii/entrevista2_segmento2.png" alt="Entrevista 2 — Segmento 2" width="4000"> </div> *Nota.* Elaboración propia. |
| **3** | **Nombre:** Lupe de la Cruz <br> **Edad:** 22 años <br> **Distrito:** Jesús María <br> **Ocupación:** Estudiante <br> **Duración de la entrevista:** Aprox. 5 minutos <br> **Enlace:** https://acortar.link/BfP5q1 <br> **Resumen:** Lupe simuló el flujo de recepción de notificaciones web push de proximidad para snacks orientales. Indicó que la funcionalidad evita con éxito malas experiencias (como encontrar locales cerrados), pero detectó que el botón para conceder permisos de localización al navegador carecía de contraste adecuado y etiquetas descriptivas legibles. Califica la usabilidad con un 4, recomendando optimizar la accesibilidad. | **Figura 8**<br> *Entrevista 3 — Segmento 1* <div align="center"> <img src="resources/imgs/chapter-ii/entrevista3_segmento2.png" alt="Entrevista 3 — Segmento 1" width="4000"> </div> *Nota.* Elaboración propia. |
